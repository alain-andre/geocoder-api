...
module GeocoderWrapper
  ...
  ADDOK_LU = Wrappers::Addok.new(CACHE, "#{ENV['ADDOK_LU_HOST'] || 'http://addok-fr'}:#{ENV['ADDOK_LU_PORT'] || '7878'}", 'Luxemburg', 'poly/luxemburg.kml', PointInPolygon.new('./poly/luxemburg.sqlite'))
